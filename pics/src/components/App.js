...
class App extends Component {
  ...
  // after creating separate config file, cut headers and base url, add to config file. Now pointing to unsplash.get instead of axios.get
  ...
  // define prop on SearchBar, is our callback being passed down as prop, handleSearchSubmit
  render() {
    return (
...
need to take the search term and pass it back up to the App, which can then make API requests and getting list of images.

imageList, not app, will display the list of images
